...
どのようなツイートを嫌がらせや脅迫と感じるかは人によって違い、客観的な判断が難しい場合もあります。この拡張機能は「あなたの基準」で「嫌がらせや脅迫」と感じるツイートを非表示にします。あなたへのリプライやあなたに関するツイートを閲覧するとき、推しに関するツイートを調べるときに心ない悪意からあなたの精神を守るための非公式のブラウザー拡張機能です。
